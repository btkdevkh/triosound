...
export default function Player() {
  ...
  const handlePlayAndPause = () => {
    ...
    refIplay.current!.classList.contains("fa-play") ? play() : pause();
  };

  const play = () => {
    if (refAudio) {
      refAudio.current!.play().catch((error) => error);
    }
  };
      ...
      {songs && songs.length > 0 && (
        <div className="player">
          <div className="player__item one">
            ...
            <div
              className="player__progress__container"
            ...
            <div className="player__controls__btns">
              <div className="player__ctr__btn">
                ...
                <button onClick={handlePlayAndPause}>
                  <i
                    ref={refIplay}
                    className={`${
                      isPlay ? "fa-solid fa-pause" : "fa-solid fa-play"
                    }`}
                  ></i>
                </button>
                <button onClick={next}>
              ...
              <div className="player__controls__setting">
                <div className="player__ctr__settings">
                  ...
                  <div className="volume__btn" onClick={mute}>
                    <input
